...
- **Key module**: `src/weatherduck/weatherduck.py` houses:
  ...
  - Dummy datasets/datamodules (single-step and timeseries), `LitWeatherDuck`, and Fiddle factories (`build_encode_process_decode_model`, `experiment_factory`, `autoregressive_experiment_factory`).
